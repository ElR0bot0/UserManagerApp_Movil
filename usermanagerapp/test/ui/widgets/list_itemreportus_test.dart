...
import 'package:f_testing_template/ui/widgets/list_itemreportus.dart';
...
void main() {
  ...
  testWidgets(
      'ListItemReportUS navigates to ReportDetailPageUS when "more" button is pressed',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      GetMaterialApp(
        home: ListItemReportUS(report),
      ),
    );
    ...
    // Verify that the ReportDetailPageUS is pushed onto the navigation stack
