...
// in f_testing_template/test/mocks/report_local_test.mocks.dart.
...
class MockIReportDataSource extends _i1.Mock implements _i3.IReportDataSource {
  ...
  @override
  _i4.Future<int> insertReport(_i5.Report? report) => (super.noSuchMethod(
        Invocation.method(
          #insertReport,
          [report],
        ),
  ...
  @override
  _i4.Future<List<_i5.Report>> getReports() => (super.noSuchMethod(
        Invocation.method(
          #getReports,
          [],
        ),
  ...
  @override
  _i4.Future<int> updateReport(_i5.Report? report) => (super.noSuchMethod(
        Invocation.method(
          #updateReport,
          [report],
        ),
  ...
  @override
  _i4.Future<int> deleteReport(int? id) => (super.noSuchMethod(
        Invocation.method(
          #deleteReport,
          [id],
        ),
